...
const Homecard1 = () => {
  ...
  return (
    <div className="hidden md:block w-fit relative h-[499.75px] lg:h-[696px] mx-[5%]">
      ...
      {/* <div className="bg-red-900 w-3/4 absolute bottom-4 right-0 flex flex-col">
      ...
      <div className="flex flex-col self-end gap-2 bg-white p-4 rounded-xl lg:rounded-2xl font-['Raleway',_sans-serif] w-3/4 absolute right-0 bottom-4">
        <div className="flex items-center gap-2">
          <span className="font-bold text-xs text-[#333333]">DEVELOPMENT</span>
          <span className="text-[#999999] text-xs font-medium">
            16 March 2023
