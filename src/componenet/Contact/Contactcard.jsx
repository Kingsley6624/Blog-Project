...
import { ContactList } from "../../Data/BlogList";
const cardList = ContactList;
    ...
    <div className="flex flex-col items-center justify-center bg-[#F9F9F9] gap-4 py-8 sm:flex-row w-full px-12 sm-px-20">
      {cardList.map((card) => (
        ...
        >
          ...
          <h3 className="font-bold text-[13.97px] text-[#7C4EE4] lg:text[20px]">
            {card.head}
          </h3>
          <p
            className="font-medium text-[11.17px]
          text-[#7A7A7A] lg:text-[16px]"
          >
            {card.content}
          </p>
        </div>
